...
export function InputGroup(props: any) {
  ...
  return (
    <Primitive
      role="group"
      base={cn(inputGroupBase, local.className, local.class)}
...
export function InputGroupAddon(props: any) {
  const [local, others] = splitProps(props, ["align", "class", "className"]);
  const align = local.align ?? "inline-start";
  return (
    <Primitive
      base={cn(addonBase, addonAlign[align], local.className, local.class)}
      data-align={align}
...
export function InputGroupInput(props: any) {
  return <Input {...props} unstyled />;
}

export function InputGroupTextarea(props: any) {
