...
import { SummaryTile } from "@orbit/ui/metric-tile";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupInput,
    ...
    <div className="min-h-svh bg-background px-6 py-12">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-4 grid grid-cols-3 gap-3">
          <SummaryTile label="Inflow" value={`+$${inflow.toLocaleString()}`} tone="positive" className="bg-card shadow-xs/5" valueClass="font-heading font-semibold" />
          <SummaryTile label="Outflow" value={`−$${outflow.toLocaleString()}`} className="bg-card shadow-xs/5" valueClass="font-heading font-semibold" />
          <SummaryTile label="Net" value={`+$${Math.abs(inflow - outflow).toLocaleString()}`} className="bg-card shadow-xs/5" valueClass="font-heading font-semibold" />
        </div>
