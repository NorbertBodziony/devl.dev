    ...
    return (<div className="min-h-svh bg-background text-foreground">
      <div className="mx-auto grid min-h-svh max-w-5xl grid-cols-[220px_1fr]">
        ...
        <main className="px-10 py-12 pb-32">
          ...
          <SettingsSection title="Identity" hint="Visible to anyone with access." layout="split">
            ...
            <SettingsField label="Name" htmlFor="ws-name">
            ...
            <SettingsField label="Slug" htmlFor="ws-slug" hint="Used in URLs.">
          ...
          <SettingsSection title="Region" hint="Defaults applied to new members and exports." layout="split">
            <SettingsField label="Timezone" htmlFor="ws-tz">
            ...
            <SettingsField label="Date format" htmlFor="ws-fmt">
          ...
          <SettingsSection title="Defaults" layout="split">
