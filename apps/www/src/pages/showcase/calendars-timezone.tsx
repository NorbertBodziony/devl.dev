    ...
    return (<Popover>
      ...
      <PopoverPopup className="!w-80 !p-0 overflow-hidden" side="top" align="start">
        <div className="flex items-center gap-2 border-border/60 border-b px-3 py-2">
          ...
          <input autoFocus value={query()} onInput={(e) => setQuery(e.target.value)} placeholder="Search zones, cities…" className="h-7 flex-1 bg-transparent text-sm outline-none placeholder:text-muted-foreground"/>
        </div>
