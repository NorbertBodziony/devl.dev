...
import { CheckCircle2Icon, CircleAlertIcon, CircleSlashIcon, CopyIcon, GlobeIcon, ImageIcon, MailIcon, RefreshCwIcon, UploadCloudIcon, } from "lucide-solid";
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_260px]">
            <div className="flex flex-wrap items-start gap-3">
              {SWATCH_DEFS.map((s) => (<Popover key={s.key} open={openKey() === s.key} onOpenChange={(o) => setOpenKey(o ? s.key : null)}>
                  <PopoverTrigger render={<button type="button" className="group flex flex-col items-center gap-1.5 rounded-xl border border-border/60 bg-background/40 p-3 transition-colors hover:border-border"/>}>
