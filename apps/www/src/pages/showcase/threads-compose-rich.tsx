    ...
    return (<div className="min-h-svh bg-background text-foreground">
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 rounded-xl border border-border/60 bg-background/40 p-3 shadow-sm focus-within:border-foreground/40">
          ...
          <textarea value={draft()} onInput={(e) => setDraft(e.target.value)} rows={5} placeholder="Reply to the thread…" className="mt-2 w-full resize-none bg-transparent px-1 text-sm leading-relaxed outline-none placeholder:text-muted-foreground"/>
