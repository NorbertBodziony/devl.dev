    ...
    return (<div className="mx-auto max-w-5xl">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-2">
        <div className="flex h-9 flex-1 min-w-[220px] items-center gap-2 rounded-md border border-border/70 bg-background/40 px-3">
          ...
          <input value={query()} onInput={(e) => setQuery(e.target.value)} placeholder="Find a project" className="flex-1 bg-transparent text-sm outline-none placeholder:text-muted-foreground"/>
        </div>
...
function MembersView() {
    ...
    return (<div className="mx-auto max-w-5xl">
      ...
      <div className="mt-6 flex h-9 max-w-md items-center gap-2 rounded-md border border-border/70 bg-background/40 px-3">
        <SearchIcon className="size-3.5 opacity-50"/>
        <input value={query()} onInput={(e) => setQuery(e.target.value)} placeholder="Find by name or email" className="flex-1 bg-transparent text-sm outline-none placeholder:text-muted-foreground"/>
      </div>
